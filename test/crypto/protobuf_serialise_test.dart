...
void main() {
  group('Protobuf Key Deserialization Tests', () {
    test('ECDSA key deserialization', () {
      ...
      expect(
        hex.encode(privateKey.data).toUpperCase(),
        privateKeyHex.substring(8).toUpperCase(),
      );
      expect(
        hex.encode(publicKey.data).toUpperCase(),
    ...
    test('ED25519 key deserialization', () {
      ...
      expect(
        ...
        publicKeyHex.substring(8).toLowerCase(),
      );
    });
    ...
    test('RSA key deserialization', () {
      ...
      expect(
        hex.encode(privateKey.data).toLowerCase(),
        privateKeyHex.substring(10).toLowerCase(),
      );
      expect(
        hex.encode(publicKey.data).toLowerCase(),
