  ...
  group('Holepunch Network Integration Tests', () {
    ...
    setUpAll(() async {
      ...
      orchestrator = ContainerOrchestrator(
        ...
        startupTimeout: const Duration(minutes: 3),
      );
    });
    ...
    test(
      'Symmetric-to-Symmetric NAT Holepunch Failure',
      () async {
    ...
    test(
      'Complete Holepunch Scenario Suite',
      () async {
        final scenarios = [
    ...
    group('Network Behavior Validation', () {
      ...
      test(
        'Circuit Relay Establishment Between Peers',
        () async {
          await orchestrator.start();
          ...
          final peerAAddrs =
              List<String>.from(peerAStatus['addresses'] as List);
          final peerBAddrs =
              List<String>.from(peerBStatus['addresses'] as List);
          final relayAddrs =
              List<String>.from(relayStatus['addresses'] as List);
          ...
          final peerABaseCircuitAddrs = peerAAddrs
              .where((addr) => addr.contains('/p2p-circuit'))
              .toList();
          final peerBBaseCircuitAddrs = peerBAddrs
              .where((addr) => addr.contains('/p2p-circuit'))
              .toList();
          ...
          expect(
            pingResult.containsKey('connection_details'),
            isTrue,
