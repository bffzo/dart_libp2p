...
void main() {
  group('NatStatusReporter', () {
    ...
    test('should provide status summary', () {
      ...
      expect(
        summary['currentBehavior']['mappingBehavior'],
        equals('endpointIndependent'),
      );
      expect(
        summary['currentBehavior']['filteringBehavior'],
      ...
      expect(
        summary['recommendedStrategyDescription'],
    ...
    test('should provide detailed report with history', () {
      ...
      expect(
        report['history'][0]['mappingBehavior'],
        equals('endpointIndependent'),
      );
      expect(
        report['history'][0]['filteringBehavior'],
        equals('addressDependent'),
      );
    ...
    test('should trigger behavior update', () async {
      ...
      expect(
        updatedBehavior.mappingBehavior,
        equals(NatMappingBehavior.addressDependent),
      );
      expect(
        updatedBehavior.filteringBehavior,
