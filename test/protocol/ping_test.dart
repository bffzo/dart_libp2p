  ...
  group('Ping Protocol', () {
    ...
    setUpAll(() async {
      ...
      when(network1.newStream(any, any)).thenAnswer((invocation) async {
        ...
        return PingPongMockStream.create(
      ...
      peerstore1.addrBook.addAddrs(peerId2, [addr2], const Duration(hours: 1));
      peerstore2.addrBook.addAddrs(peerId1, [addr1], const Duration(hours: 1));
