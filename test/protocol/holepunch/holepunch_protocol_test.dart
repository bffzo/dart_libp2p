  ...
  group('DCUtR Protocol Compliance Tests', () {
    group('Protocol Messages', () {
      test('should create CONNECT message correctly', () {
        ...
        expect(
          reconstructedAddrs[0].toString(),
          equals(addresses[0].toString()),
        );
        expect(
          reconstructedAddrs[1].toString(),
          equals(addresses[1].toString()),
        );
      });
      ...
      test('should serialize and deserialize CONNECT message', () {
        ...
        expect(
          deserializedAddrs[0].toString(),
          equals(originalAddresses[0].toString()),
        );
        expect(
          deserializedAddrs[1].toString(),
    ...
    group('Address Encoding/Decoding', () {
      ...
      test('should handle mixed IPv4 and IPv6 addresses', () {
        ...
        for (var i = 0; i < mixedAddresses.length; i++) {
    ...
    group('Message Size Limits', () {
      test('should respect maximum message size limits', () {
        ...
        final reasonableAddresses = List.generate(
          5,
          (i) => MultiAddr('/ip4/192.168.1.${i + 100}/tcp/400${i + 1}'),
        );
      ...
      test('should handle large number of addresses efficiently', () {
        ...
        final manyAddresses = List.generate(
          20,
          (i) => MultiAddr('/ip4/10.0.${i ~/ 256}.${i % 256}/tcp/${4000 + i}'),
        );
