  ...
  group('RelayFinder', () {
    ...
    group('Circuit Address Construction', () {
      test('should construct valid circuit addresses from reservations',
        ...
        final reservation = Reservation(
          DateTime.now().add(const Duration(hours: 1)), // expire
        ...
        expect(
          await relayFinder.hasRelay(relayPeerId),
          isTrue,
        ...
        expect(
          circuitAddrsWithRelayId.length,
          equals(2),
      ...
      test('should construct valid circuit address format', () {
        ...
        const relayId = '12D3KooWRcr1tPJ5D46uESVgA1sJrNmcGrW2XHGcHztHadBvcv3G';
        final relayAddr = MultiAddr('/ip4/10.10.3.10/tcp/4001');
    ...
    group('Reservation Management', () {
      ...
      test('should detect expired reservations', () {
        ...
        final expiration = DateTime.now().subtract(const Duration(minutes: 1));
        final reservation = Reservation(
          expiration, // expire
          [], // addrs
          null, // voucher
    ...
    group('Edge Cases', () {
      ...
      test('should handle malformed addresses gracefully', () async {
        ...
        expect(
          () async => relayFinder.getRelayAddrs(currentHostAddrs),
          returnsNormally,
        );
      });
    });
