  ...
  group('ResourceManagerImpl', () {
    ...
    group('with restrictive limits', () {
      ...
      setUp(() async {
        final testLimiter = TestLimiter(
          connLimits: BaseLimit(
            ...
            connsOutbound: 1,
            memory: 1024,
          ), // For ConnectionScopeImpl's own limit
          streamLimits: BaseLimit(
            streams: 1,
            streamsInbound: 1,
            streamsOutbound: 1,
            memory: 1024,
          ), // For StreamScopeImpl's own limit
          ...
          protocolLimits: BaseLimit(
            ...
            streamsOutbound: 1,
            memory: 1024,
          ), // For ProtocolScopeImpl's own limit
        );
      ...
      test('exceeding connection limit throws ResourceLimitExceededException',
        ...
        expect(
          () async => limitedResourceManager.openConnection(
            Direction.outbound,
            false,
            testMultiAddr,
          ),
      ...
      test(
        ...
        expect(
          () async => limitedResourceManager.openStream(
            peerA,
            Direction.outbound,
          ),
          throwsA(isA<network_errors.ResourceLimitExceededException>()),
        ...
        expect(
          () async {
            ...
            await streamScope2.setProtocol(
              testProto,
            ); // This might re-acquire/re-incRef the protocol scope
