...
void main() {
  test(
    'detailed stream creation and data transfer',
    () async {
      print('\n=== Test Setup ===');
      ...
      try {
        ...
        final stream1Future = session1
            .openStream(core_context.Context()); // Changed to openStream
        ...
        final stream1 = await stream1Future.timeout(
          ...
          onTimeout: () => throw TimeoutException(
            'Timeout waiting for client stream creation',
          ),
        ) as YamuxStream;
