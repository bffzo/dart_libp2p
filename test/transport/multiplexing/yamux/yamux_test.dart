...
Future<T> withTimeout<T>(Future<T> future, String operation) {
  return future.timeout(
    const Duration(seconds: 30), // Increased timeout for slower systems
...
void main() {
  group('Yamux Multiplexing', () {
    ...
    test('enforces maximum streams limit', () async {
      ...
      const testMaxStreams = 10; // Reduced from 50 to 10 for stability
      const testConfig = MultiplexerConfig(
