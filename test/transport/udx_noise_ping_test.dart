...
void main() {
  ...
  group('Swarm with UDX, Noise, and Ping', () {
    ...
    setUpAll(() async {
      ...
      print(
        'Swarm UDX/Noise/Ping Setup Complete. Client: $clientPeerId, Server: $serverPeerId listening on $serverListenAddr',
      );
    });
    ...
    test(
      ...
      () async {
        print(
          'Client Host ($clientPeerId) attempting to open new stream to Server Host ($serverPeerId) for protocol ${PingConstants.protocolId}',
        );
