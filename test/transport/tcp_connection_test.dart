...
void main() {
  ...
  group('TCPConnection Read Operations', () {
    ...
    test(
      ...
      final dataChunk2 = Uint8List.fromList([6, 7, 8]);
      final readFuture3 = clientConnection.read();
  ...
  group('TCPConnection Write Operations', () {
    ...
    test(
        ...
        () async {
      final data = Uint8List.fromList([1, 2, 3]);
      const exception = SocketException('Failed to add');
    ...
    test(
        ...
        () async {
      final data = Uint8List.fromList([1, 2, 3]);
      const exception = SocketException('Failed to flush');
    ...
    test('multiple writes should be synchronized and execute sequentially',
      ...
      final flush1Completer = Completer<void>();
      final flush2Completer = Completer<void>();
      final flush3Completer = Completer<void>();
