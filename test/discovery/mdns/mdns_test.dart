...
void main() {
  ...
  group('MdnsDiscovery', () {
    ...
    test('debugInjectPeer notifies the notifee', () async {
      ...
      final testAddr = MultiAddr('/ip4/127.0.0.1/udp/4001/udx/p2p/$testPeerId');
      ...
      expect(
        notifee.discoveredPeers.first.addrs.first.toString(),
    ...
    test('findPeers forwards discovered peers to returned stream', () async {
      ...
      final discoveredAddr =
          MultiAddr('/ip4/127.0.0.1/udp/4001/udx/p2p/$testPeerId');
      ...
      expect(
        received.addrs.first.toString(),
        equals(discoveredAddr.toString()),
      );
    ...
    test('handles host with multiple addresses', () async {
      final addr1 = MultiAddr('/ip4/127.0.0.1/udp/4001/udx/p2p/$testPeerId');
      final addr2 = MultiAddr(
        '/ip4/192.168.1.100/udp/4002/udx/p2p/$testPeerId',
      );
