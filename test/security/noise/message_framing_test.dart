  ...
  group('MessageFraming', () {
    test('adds length prefix correctly', () {
      final testCases = [
        ...
        ), // Message with length > 255
        Uint8List(0), // Empty message
        Uint8List.fromList(
          List.generate(65535, (i) => i % 256),
    ...
    test('handles maximum message size', () {
      ...
      expect(
        framedMax.length, equals(65537), // 65535 + 2 bytes prefix
      ...
      expect(
        MessageFraming.extractLength(tooLargePrefix),
        equals(0),
