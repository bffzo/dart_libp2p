...
Future<void> main(List<String> arguments) async {
  ...
  try {
    ...
    if (targetAddrStr != null) {
      ...
      if (connectAddr != null) {
        await host.peerStore.addrBook
            .addAddrs(targetPeerId, [connectAddr], const Duration(hours: 1));
        print(
      ...
      while (true) {
        ...
        try {
          ...
          var success = pongData.lengthInBytes == payload.lengthInBytes;
          if (success) {
    ...
    final finalHostId = host != null ? shortPeerId(host.id) : 'Host';
