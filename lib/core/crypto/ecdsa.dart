...
class EcdsaPublicKey implements p2pkeys.PublicKey {
  ...
  factory EcdsaPublicKey.fromRawBytes(Uint8List bytes) {
    try {
      ...
      throw ECDSAKeyException(
        'Failed to parse ECDSA public key: $e',
      );
    }
  }
  ...
  Uint8List get raw {
    try {
      ...
      throw ECDSAKeyException(
        'Failed to encode ECDSA public key: $e',
      );
    }
  }
...
class EcdsaPrivateKey implements p2pkeys.PrivateKey {
  ...
  static Future<p2pkeys.PrivateKey> fromRawBytes(Uint8List bytes) async {
    try {
      ...
      throw ECDSAKeyException(
        'Failed to parse ECDSA private key: $e',
      );
    }
  }
  ...
  Uint8List get raw {
    try {
      ...
      throw ECDSAKeyException(
        'Failed to encode ECDSA private key: $e',
      );
    }
  }
  ...
  Future<Uint8List> sign(Uint8List data) async {
    try {
      ...
      throw ECDSAKeyException('Failed to sign data: $e');
    }
  }
