...
class StreamScopeImpl extends ResourceScopeImpl
  ...
  // Added ResourceManagerImpl reference
  ...
  } // Initial edges: peer, transient, system
  ...
  Future<void> setProtocol(ProtocolID protocol) async {
    ...
    try {
      ...
      if (reservationError == null) {
        ...
        final oldEdges = List<ResourceScopeImpl>.from(edges);
        final newEdges = <ResourceScopeImpl>[_peerScopeImpl, newPeerProtoScope];
  ...
  Future<void> setService(String serviceName) async {
    ...
    network_errors.ResourceLimitExceededException? reservationError;
    var reservedInSvc = false;
    var reservedInPeerSvc = false;
    ...
    try {
      ...
      if (reservationError == null) {
        ...
        final oldEdges = List<ResourceScopeImpl>.from(edges);
        final newEdges = <ResourceScopeImpl>[
          _peerScopeImpl,
