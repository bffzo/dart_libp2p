...
class OBPFrame {
  ...
  Uint8List encode() {
    ...
    // Stream ID (4 bytes)
    buffer.setUint32(offset, streamId);
    offset += 4;
  ...
  static OBPFrame decode(Uint8List data) {
    ...
    // Check magic
    final magic = buffer.getUint32(offset);
    if (magic != MAGIC) {
    ...
    // Length
    final length = buffer.getUint32(offset);
    ...
    // Stream ID
    final streamId = buffer.getUint32(offset);
    offset += 4;
